...
(function (lobby) {
    ...
    (function (panel) {
        var GameHistoryPanelBase = /** @class */ (function (_super) {
            ...
            GameHistoryPanelBase.prototype.initlistener = function () {
                EventManager.register(game.event.GameEvent.UPDATE_GAME_REC, this, this.updateHistoryView);
            };
            GameHistoryPanelBase.prototype.unInitlistener = function () {
