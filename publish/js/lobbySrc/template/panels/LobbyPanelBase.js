    ...
    (function (panel) {
        var LobbyPanelBase = /** @class */ (function (_super) {
            ...
            LobbyPanelBase.prototype.initComponents = function () {
                ...
                //玩家钱包
                this.playerWalletBox = this.bindScript(lobby.component.PlayerWalletBox, this.playerInfoBoxObj.playerWalletBoxObj);
                //底部按钮条
                ...
                //退出按钮
                EventManager.addTouchScaleListener(this.exitBtns.exitBtn, this, this.exitBtnFunc);
                //
            ...
            LobbyPanelBase.prototype.resize = function () {
                ...
                if (Laya.stage.width / Laya.stage.height > wh) { //宽屏
                    this.exitBtns.right = 78;
                    this.playerInfoBoxObj.x = 0;
                    this.marqueeBoxObj.x = 519;
                    this.versionLabel.x = 66;
                }
                else {
                    this.exitBtns.right = 28;
                    this.playerInfoBoxObj.x = -52;
                    //this.marqueeBoxObj.left = 435;
                    this.marqueeBoxObj.x = 330;
                    this.versionLabel.x = 16;
                }
            };
            //注册监听
